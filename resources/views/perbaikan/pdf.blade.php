...
<body onload="window.print()">
    ...
    <table width="100%" style="border: 0;">
        ...
        <tr>
            ...
            <td></td>
            <td class="text-right">Rp. {{ $perbaikan->biaya }}</td>
        </tr>

        <tr>
            <td>Diskon:</td>
            <td></td>
            <td class="text-right">Rp. {{ $perbaikan->diskon }}</td>
        </tr>
        {{-- @endforeach --}}
    </table>
    <p class="text-center">===================================</p>
    ...
    <table width="100%" style="border: 0;">
        <tr>
            ...
            <td class="text-right">Rp.
                {{ $total_biaya = $perbaikan->biaya - $perbaikan->diskon }}
            </td>
        </tr>
        <tr>
            <td>Tunai:</td>
            <td class="text-right">Rp. {{ $perbaikan->bayar }}</td>
        </tr>
        <tr>
            <td>Kembali:</td>
            <td class="text-right">Rp. {{ $perbaikan->bayar - $total_biaya }}</td>
        </tr>
        <tr>
            <td></td>
            <td class="text-right"><b>{{ $perbaikan->status_lunas }}</b></td>
        </tr>
    </table>
    <p class="text-center">===================================</p>
    <br>
