...
<body onload="window.print()">
    ...
    <table width="100%" style="border: 0;">
        ...
        <tr>
            <td>{{ $pemasangan->toPaket->paket }}</td>
            <td></td>
            <td class="text-right">Rp. {{ $pemasangan->toPaket->iuran }}</td>
        </tr>
        <tr>
            <td>Instalasi</td>
            <td></td>
            <td class="text-right">Rp. {{ $pemasangan->toPaket->instalasi }}</td>
        </tr>
        <tr>
            <td>Diskon:</td>
            <td></td>
            <td class="text-right">Rp. {{ $pemasangan->diskon }}</td>
        </tr>
        {{-- @endforeach --}}
    </table>
    <p class="text-center">===================================</p>
    ...
    <table width="100%" style="border: 0;">
        <tr>
            ...
            <td class="text-right">Rp.
                {{ $total_biaya = $pemasangan->toPaket->iuran + $pemasangan->toPaket->instalasi - $pemasangan->diskon }}
            </td>
        </tr>
        <tr>
            <td>Tunai:</td>
            <td class="text-right">Rp. {{ $pemasangan->bayar }}</td>
        </tr>
        <tr>
            <td>Kembali:</td>
            <td class="text-right">Rp. {{ $pemasangan->bayar - $total_biaya }}</td>
        </tr>
        <tr>
            {{-- <td>Kembali:</td> --}}
            <td></td>
            <td class="text-right"><b>{{ $pemasangan->status_lunas }}</b></td>
        </tr>
    </table>
    <p class="text-center">===================================</p>
    <br>
